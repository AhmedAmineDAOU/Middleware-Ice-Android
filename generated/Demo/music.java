                              ...
                              java.io.Serializable
{
    ...
    public music(String id, String name, String author, String album, String genre, String url, int minutes, int seconds, int fav)
    {
        this.id = id;
        this.name = name;
        this.author = author;
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::Demo::music");
        ...
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, fav);
        return h_;
    }
    ...
    public static final long serialVersionUID = 1894235496857626745L;
}
